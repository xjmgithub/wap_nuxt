...
function sizeHandler() {
    ...
    if ($('#canvas')) {
        ...
        var e = getSize('Width'),
            ...
            g = 0
        b < a
            ? ((g = a - b), (b += g), (c += (CANVAS_WIDTH / CANVAS_HEIGHT) * g))
            : c < e && ((g = e - c), (c += g), (b += (CANVAS_HEIGHT / CANVAS_WIDTH) * g))
        var g = a / 2 - b / 2,
            h = e / 2 - c / 2,
            k = CANVAS_WIDTH / c
        if (h * k < -EDGEBOARD_X || g * k < -EDGEBOARD_Y)
...
function calculateIntersection(a, e) {
    ...
    c = Math.abs(c - f) - (h + l)
    return 0 > b && 0 > c
        ? ((b = Math.min(Math.min(a.width, e.width), -b)),
          (c = Math.min(Math.min(a.height, e.height), -c)),
          {
              x: Math.max(a.x, e.x),
              y: Math.max(a.y, e.y),
              width: b,
...
function getBounds(a, e) {
    ...
    if (a instanceof createjs.Container) {
        ...
        a instanceof createjs.Bitmap
            ? ((g = a.sourceRect || a.image), (k = g.width * e), (d = g.height * e))
            : a instanceof createjs.Sprite
                ? a.spriteSheet._frames && a.spriteSheet._frames[a.currentFrame] && a.spriteSheet._frames[a.currentFrame].image
                    ? ((g = a.spriteSheet.getFrame(a.currentFrame)), (k = g.rect.width), (d = g.rect.height), (c = g.regX), (f = g.regY))
                    : ((b.x = a.x || 0), (b.y = a.y || 0))
                : ((b.x = a.x || 0), (b.y = a.y || 0))
        c = c || 0
        k = k || 0
        ...
        b.x = Math.min(Math.min(Math.min(g.x, h.x), k.x), c.x)
...
;(function() {
    function a(b) {
        ...
        b = b || window.event
        b.type in a
            ? (document.body.className = a[b.type])
...
function CPreloader() {
    ...
    this._init = function() {
        ...
        s_oSpriteLibrary.addSprite('bg_menu', '/res_nuxt/acon/sprites/bg_menu.jpg')
        s_oSpriteLibrary.addSprite('progress_bar', '/res_nuxt/acon/sprites/progress_bar.png')
        ...
        createjs.Sound.initializeDefaultPlugins() &&
            (0 < navigator.userAgent.indexOf('Opera') || 0 < navigator.userAgent.indexOf('OPR')
                ? ((createjs.Sound.alternateExtensions = ['mp3']),
                  ...
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/soundtrack.ogg', 'soundtrack'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/press_but.ogg', 'click'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/applause.ogg', 'applause'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/crowd.ogg', 'crowd'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/goal.ogg', 'goal'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/keeper_save.ogg', 'keeper_save'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/kick.ogg', 'kick'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/miss_goal.ogg', 'miss_goal'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/select_team.ogg', 'select_team'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/game_over.ogg', 'game_over'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/stop_indicator.ogg', 'stop_indicator'))
                : ((createjs.Sound.alternateExtensions = ['ogg']),
                  createjs.Sound.addEventListener('fileload', createjs.proxy(this.soundLoaded, this)),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/soundtrack.mp3', 'soundtrack'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/press_but.mp3', 'click'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/applause.mp3', 'applause'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/crowd.mp3', 'crowd'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/goal.mp3', 'goal'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/keeper_save.mp3', 'keeper_save'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/kick.mp3', 'kick'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/miss_goal.mp3', 'miss_goal'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/select_team.mp3', 'select_team'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/game_over.mp3', 'game_over'),
                  createjs.Sound.registerSound('/res_nuxt/acon/sounds/stop_indicator.mp3', 'stop_indicator')),
            (c += 11))
    }
    this._loadImages = function() {
        s_oSpriteLibrary.init(this._onImagesLoaded, this._onAllImagesLoaded, this)
        s_oSpriteLibrary.addSprite('but_play', '/res_nuxt/acon/sprites/but_play.png')
        s_oSpriteLibrary.addSprite('msg_box', '/res_nuxt/acon/sprites/msg_box.png')
        s_oSpriteLibrary.addSprite('but_restart', '/res_nuxt/acon/sprites/but_restart.png')
        s_oSpriteLibrary.addSprite('bg_menu', '/res_nuxt/acon/sprites/bg_menu.jpg')
        ...
        s_oSpriteLibrary.addSprite('ball_kick_left', '/res_nuxt/acon/sprites/ball_kick_left.png')
        s_oSpriteLibrary.addSprite('_oButNext', '/res_nuxt/acon/sprites/arrow.png')
        s_oSpriteLibrary.addSprite('arrow_bar', '/res_nuxt/acon/sprites/arrow_bar.png')
        s_oSpriteLibrary.addSprite('but_continue', '/res_nuxt/acon/sprites/but_continue.png')
        s_oSpriteLibrary.addSprite('but_continue_small', '/res_nuxt/acon/sprites/but_continue_small.png')
        s_oSpriteLibrary.addSprite('argentina', '/res_nuxt/acon/sprites/flag_argentina.png')
        s_oSpriteLibrary.addSprite('brazil', '/res_nuxt/acon/sprites/flag_brazil.png')
        s_oSpriteLibrary.addSprite('germany', '/res_nuxt/acon/sprites/flag_germany.png')
        s_oSpriteLibrary.addSprite('england', '/res_nuxt/acon/sprites/flag_england.png')
        s_oSpriteLibrary.addSprite('italy', '/res_nuxt/acon/sprites/flag_italy.png')
        s_oSpriteLibrary.addSprite('france', '/res_nuxt/acon/sprites/flag_france.png')
        s_oSpriteLibrary.addSprite('goal', '/res_nuxt/acon/sprites/goal.png')
        s_oSpriteLibrary.addSprite('high_bar', '/res_nuxt/acon/sprites/high_bar.png')
        s_oSpriteLibrary.addSprite('right_bar', '/res_nuxt/acon/sprites/right_bar.png')
        s_oSpriteLibrary.addSprite('but_exit', '/res_nuxt/acon/sprites/but_exit.png')
        s_oSpriteLibrary.addSprite('audio_icon', '/res_nuxt/acon/sprites/audio_icon.png')
        s_oSpriteLibrary.addSprite('icon_goal', '/res_nuxt/acon/sprites/icon_goal.png')
        s_oSpriteLibrary.addSprite('icon_kick', '/res_nuxt/acon/sprites/icon_kick.png')
        s_oSpriteLibrary.addSprite('goal_text', '/res_nuxt/acon/sprites/goal_text.png')
        ...
        s_oSpriteLibrary.addSprite('england_shot', '/res_nuxt/acon/sprites/players/england_shot.png')
        s_oSpriteLibrary.addSprite('italy_shot', '/res_nuxt/acon/sprites/players/italy_shot.png')
        s_oSpriteLibrary.addSprite('france_shot', '/res_nuxt/acon/sprites/players/france_shot.png')
        s_oSpriteLibrary.addSprite('goalkeeper_idle', '/res_nuxt/acon/sprites/players/goalkeeper_idle.png')
        s_oSpriteLibrary.addSprite('goalkeeper_center', '/res_nuxt/acon/sprites/players/goalkeeper_center.png')
        s_oSpriteLibrary.addSprite('goalkeeper_center_high', '/res_nuxt/acon/sprites/players/goalkeeper_center_high.png')
        s_oSpriteLibrary.addSprite('goalkeeper_down_left', '/res_nuxt/acon/sprites/players/goalkeeper_down_left.png')
        s_oSpriteLibrary.addSprite('goalkeeper_down_right', '/res_nuxt/acon/sprites/players/goalkeeper_down_right.png')
        s_oSpriteLibrary.addSprite('goalkeeper_high_left', '/res_nuxt/acon/sprites/players/goalkeeper_high_left.png')
        s_oSpriteLibrary.addSprite('goalkeeper_high_right', '/res_nuxt/acon/sprites/players/goalkeeper_high_right.png')
        s_oSpriteLibrary.addSprite('goalkeeper_med_left', '/res_nuxt/acon/sprites/players/goalkeeper_med_left.png')
        s_oSpriteLibrary.addSprite('goalkeeper_med_right', '/res_nuxt/acon/sprites/players/goalkeeper_med_right.png')
        s_oSpriteLibrary.addSprite('wall_idle', '/res_nuxt/acon/sprites/players/wall_idle.png')
        s_oSpriteLibrary.addSprite('wall_jump', '/res_nuxt/acon/sprites/players/wall_jump.png')
        s_oSpriteLibrary.addSprite('ball', '/res_nuxt/acon/sprites/ball.png')
        for (var a = 0; a < NUM_CROWD; a++)
            s_oSpriteLibrary.addSprite('supporters_' + a, '/res_nuxt/acon/sprites/supporters/supporters_' + a + '.png')
    ...
    this._init = function() {
        ...
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile)
            (f = s_oSpriteLibrary.getSprite('audio_icon')),
                ...
                (c = f.height / 2 + 10),
                (d = new CToggle(b, c, f, s_bAudioActive)),
...
function CGame(a, e) {
    ...
    this.createViewThings = function() {
        ...
        s_oStage.addChild(T)
        if (0 < B.num) for (var a = 0; a < B.num; a++) (K[a] = new CWall(B.x, B.y, T, a)), K[a].showIdle(a)
    ...
    this.showMessage = function(a) {
        ...
        !0 === a
            ...
            : !0 === p
                ...
                : l === OUT
                    ? ((a = createBitmap(s_oSpriteLibrary.getSprite('out_text'))),
                      (a.scaleX = 0),
                      (a.scaleY = 0),
                      (a.alpha = 0),
                      (a.x = CANVAS_WIDTH / 2),
                    ...
                    : H !== l &&
                      l !== OUT &&
                      ((a = createBitmap(s_oSpriteLibrary.getSprite('goal_text'))),
                      (a.scaleX = 0),
                      (a.scaleY = 0),
                      (a.alpha = 0),
                      (a.x = CANVAS_WIDTH / 2),
    ...
    this.controlWall = function() {
        var a = y.returnX(),
            b = y.returnY()
        0 < B.num &&
            !0 === K[0].controlIfHitted(a, b, B.num) &&
            (y.bounce(D.x, 0), !1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) &&
            (createjs.Sound.play('keeper_save'), createjs.Sound.play('miss_goal'))
    }
    this.goalKeeperBounce = function() {
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) createjs.Sound.play('keeper_save'), createjs.Sound.play('miss_goal')
        y.bounce(D.x, 1)
    }
    ...
    this._initKickPoints = function() {
        ...
        for (var a = 0; a < RANGE_WIDTH; a++) {
            A[a] = []
            for (var b1 = 0; b1 < RANGE_HEIGHT; b1++) {
                var c = 0,
                    d = 0
                A[a][b1] = {
                    x: 0,
                ...
                d = Math.round(((MATRIX_Y_END - MATRIX_Y_START) / RANGE_HEIGHT) * b1 + MATRIX_Y_START) + 5
                A[a][b1].x = c
                A[a][b1].y = d
            }
        }
        ...
        if (u) {
            if (v && ((d = C.getFrame()), 4 === d && !z)) {
                if (Math.floor(100 * Math.random()) <= f && 0 < l && 0 < f) (H = l), l !== OUT && (p = !0)
                    ...
                    do H = Math.floor(Math.random() * NUM_SAVE)
                    while (H === l)
                }
                switch (H) {
                    case CENTER:
...
function CInterface(a) {
    ...
    this.help = function() {
        ...
        a =
            !1 === s_bMobile
                ? new createjs.Text(HELP_TEXT_DESKTOP, ' 25px ' + TEXT, '#ffffff')
                : new createjs.Text(HELP_TEXT_MOBILE, ' 25px ' + TEXT, '#ffffff')
        a.x = CANVAS_WIDTH / 2
        a.y = 180
        a.textAlign = 'center'
    ...
    this._onButHelpRelease = function() {
        s_oStage.removeChild(f)
        f.off('mousedown', this._onButHelpRelease)
        I = !0
        s_oGame.setUpdate()
    }
...
function CGoalKeeper(a) {
    ...
    this.showAction = function(g, h, k, d, f, l) {
        e = {
            images: [s_oSpriteLibrary.getSprite('goalkeeper_' + k)],
            framerate: 15,
            frames: {
                width: f,
                height: l,
...
function CLevel(a, e, b) {
    ...
    this.viewNextLevelPanel = function() {
        ...
        t = new createjs.Text('CONGRATULATIONS!! ', ' 60px ' + TEXT, '#000000')
...
function CBall(a, e, b) {
    ...
    this._calculateMid = function(a, b) {
        ...
        c =
            b.x < CANVAS_WIDTH / 2
                ? b.y > CANVAS_HEIGHT / 2
                    ? new createjs.Point(Math.floor((CANVAS_WIDTH / 2) * Math.random()) + 100, CANVAS_HEIGHT / 2 - 200 - c)
                    : new createjs.Point(Math.floor((CANVAS_WIDTH / 2) * Math.random()) + 100, CANVAS_HEIGHT / 2 - 200 + c)
                : b.x > CANVAS_WIDTH / 2
                    ? b.y > CANVAS_HEIGHT / 2
                        ? new createjs.Point(Math.floor((CANVAS_WIDTH / 2) * Math.random()) + 300, CANVAS_HEIGHT / 2 - 200 - c)
                        : new createjs.Point(Math.floor((CANVAS_WIDTH / 2) * Math.random()) + 300, CANVAS_HEIGHT / 2 - 200 + c)
                    : b.x > CANVAS_WIDTH / 2
                        ? new createjs.Point(CANVAS_WIDTH / 2 - 50, Math.floor((CANVAS_HEIGHT / 2) * Math.random() - 100) + 100)
                        : new createjs.Point(CANVAS_WIDTH / 2 + 50, Math.floor((CANVAS_HEIGHT / 2) * Math.random() - 100) + 100)
        f = {
            start: a,
            end: b,
    ...
    this._updateBall = function(a, b) {
        ...
        d.rotation += 5
        40 < c && ((c = 0), (g = !1), (h = !0), s_oGame.showMessage(!1))
        if (!h) {
            var e
            ...
            d.x = e.x
            d.y = e.y
            !0 === b && 0.7 >= d.scaleX && s_oGame.goalKeeperBounce()
            0 < a && 0.75 >= d.scaleX && s_oGame.controlWall()
            0.4 <= d.scaleX && ((d.scaleX -= 0.03), (d.scaleY -= 0.03))
        }
    }
...
function CCrowd() {
    var a = [],
        ...
        b = 0
    this._init = function() {
        for (var b = 0; b < NUM_CROWD; b++)
            a.push(createBitmap(s_oSpriteLibrary.getSprite('supporters_' + b))),
                (a[b].x = 0),
                (a[b].y = 90),
                (a[b].visible = !1),
...
function CShotIndicatorController(a, e) {
    ...
    this.init = function(a, e) {
        ...
        if (!1 === e) {
            ...
            (f = s_oSpriteLibrary.getSprite('right_bar')),
                (f = createBitmap(f)),
                r.addChild(f),
                (r.x = CANVAS_WIDTH / 2 + 345),
                (r.y = CANVAS_HEIGHT / 2 - 130),
                (f = s_oSpriteLibrary.getSprite('arrow_bar')),
                (n = createBitmap(f)),
                (n.x = 60),
                (n.y = 0),
    ...
    this.getPositionBallEnd = function() {
        return d ? Math.floor(n.y / l) : Math.floor(n.x / l)
    }
