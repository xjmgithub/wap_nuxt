    ...
    head() {
        return {
            ...
            meta: [
                ...
                { name: 'al:android:url', property: 'al:android:url', content: 'starvideo://platformapi/webtoapp?target=' + Base64.encode(`com.star.mobile.video.player.PlayerVodActivity?vodId=${this.id}`.replace(/&/g, '**')) },
