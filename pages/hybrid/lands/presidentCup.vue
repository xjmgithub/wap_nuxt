<template>
    <div class="wrapper">
        <img src="~assets/img/landpage/pre-cup.jpg" class="bg" alt="StarTimes APP" @click="down()" />
        <div>
            <img src="~assets/img/landpage/pre-down.png" class="btn" alt="StarTimes APP" @click="down()" />
        </div>
    </div>
</template>
<script>
