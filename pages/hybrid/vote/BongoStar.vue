...
export default {
    ...
    data() {
        return {
            ...
            vodMsg: {
                programdetails:
                    'Bongo Star Search presents a unique platform to the youths whose talent lacks exposure or the funds to support and advance it.',
                vodTime: ['2018/11/11 18:30:00', '2018/11/18 18:30:00', '2018/11/25 18:30:00', '2018/12/2 18:30:00', '2018/12/9 18:30:00'],
                description: [
