...
export default {
    ...
    mounted() {
        ...
        this.payToken = this.$router.query.payToken || this.payToken
        this.payChannelId = this.$router.query.channelId || this.payChannelId
    ...
    methods: {
        ...
        nextStep() {
            ...
            let order = this.$router.query.txNo || localStorage.getItem('txNo')
