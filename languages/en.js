export default {
    ...
    notnow_btn: 'NOT NOW',
    about_btn: 'ABOUT',
    about: '<P>Kalasha International Film and TV awards 2019 is organised by Kenya Film Commission in conjunction with StarTimes Kenya. Members of the public are encouraged to watch and vote for their favorite films, documentaries, actors, actresses and producers on StarTimes ON, the only screening and voting platform for the awards. Let\'s all support our film industry through voting for our favorite nominees!</P><P>Voting Rule:</P><P>StarTimes ON will be the only online voting platform for the awards. To cast a vote for either award, you must download & install StarTimes ON mobile app.</P><P>You can only vote once per category.</P><P>Voting Period: Voting for the Awards begins at 0:00 a.m. GMT on Nov 1, 2019, and ends at 12:59 p.m. GMT on Nov 22, 2019.</P>',
