export default {
    ...
    activity_rules_3:
        's-After successful registration, please login in App within 7 days to receive the reward. If the reward exceeds 7 days, it will be invalid.',
