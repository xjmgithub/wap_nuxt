export default {
    ...
    about_btn: 'À propos',
    about: '<P>Le Kalasha International Film and TV awards de 2019 (Le festival international 2019 du film et de la télévision  de Kalasha) est organisé par la Commission du cinéma du Kenya en collaboration avec StarTimes Kenya. Les spectateurs sont invités à regarder et à voter pour leurs films, documentaires, acteurs, actrices et producteurs préférés sur StarTimes ON, la seule plate-forme de visionnage et de vote pour les prix. Soutenons notre industrie du cinéma en votant pour nos candidats préférés!</P><P>Modalités de vote:</P><P>StarTimes ON sera la seule plate-forme de vote en ligne pour les prix. Pour voter, vous devez télécharger et installer l\'application mobile StarTimes ON.</P><P>Vous ne pouvez voter qu\'une fois pour chaque catégorie.</P><P>Période de vote: Les votes pour les prix commencent à 00h00 GTM le 1er novembre 2019 et se termineront à 12h59 GTM le 22 novembre 2019.</P>',
