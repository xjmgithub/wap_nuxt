export default {
    ...
    apiURL: 'http://app-gateway.production.eu-west-1.startimes.aws.local/',
    mechantRequestUrl: 'http://app-gateway.production.eu-west-1.startimes.aws.local/', // 'http://172.31.39.21:8010/',
